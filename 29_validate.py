...
#you can use [] to limit the no of characters allowed    well easy way out is \w which means word character which includes a-z A-Z and 0-9 while \W means not word character and similarly for \s and \S and \d and \D and i bet no further explanation needed as you got it 
  print("vallid")
